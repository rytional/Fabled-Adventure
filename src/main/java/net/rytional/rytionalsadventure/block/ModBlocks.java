...
import net.rytional.rytionalsadventure.block.custom.TravishniumOre;
...
public class ModBlocks {
    ...
    public static final Block TRAVISHNIUM_ORE_BLOCK = registerBlock("travishnium_ore_block",
            new TravishniumOre(FabricBlockSettings.of(Material.STONE).strength(1.5f).requiresTool()), ModItemGroup.RYTIONAL);
