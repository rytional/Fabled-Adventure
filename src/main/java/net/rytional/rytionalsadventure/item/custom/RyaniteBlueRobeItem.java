...
public class RyaniteBlueRobeItem extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

   public RyaniteBlueRobeItem(ArmorMaterial materialIn, EquipmentSlot slot, Item.Settings builder)  {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = new HashSet<>(armorList).containsAll(Arrays.asList(ModItems.RYANITE_BLUE_BOOTS, ModItems.RYANITE_BLUE_LEGGINGS, ModItems.RYANITE_BLUE_CHESTPLATE, ModItems.RYANITE_BLUE_HELMET));
