...
public class NaturiteStumpScreen extends HandledScreen<NaturiteStumpScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(FabledAdventure.MOD_ID, "textures/gui/naturite_stump_gui.png");

    public NaturiteStumpScreen(NaturiteStumpScreenHandler handler, PlayerInventory inventory, Text title) {
