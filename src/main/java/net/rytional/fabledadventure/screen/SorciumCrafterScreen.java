...
public class SorciumCrafterScreen extends HandledScreen<SorciumCrafterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(FabledAdventure.MOD_ID, "textures/gui/sorcium_crafter_gui.png");

    public SorciumCrafterScreen(SorciumCrafterScreenHandler handler, PlayerInventory inventory, Text title) {
