...
public class GinormiumTableScreen extends HandledScreen<GinormiumTableScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(FabledAdventure.MOD_ID, "textures/gui/ginormium_table_gui.png");

    public GinormiumTableScreen(GinormiumTableScreenHandler handler, PlayerInventory inventory, Text title) {
