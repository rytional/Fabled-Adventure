...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ULTIUM("ultium", 40, new int[]{3, 6, 8, 4}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_TURTLE, 3.2f, 0.4f,
            () -> Ingredient.ofItems(ModItems.ULTIUM_INGOT)),

    SORCIUM("sorcium", 40, new int[]{3, 6, 8, 4}, 25,
    SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.2f, 0.4f,
            () -> Ingredient.ofItems(ModItems.SORCIUM_INGOT));
