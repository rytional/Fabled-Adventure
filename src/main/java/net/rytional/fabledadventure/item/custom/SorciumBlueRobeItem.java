   ...
   public SorciumBlueRobeItem(ArmorMaterial materialIn, EquipmentSlot slot, Item.Settings builder)  {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = new HashSet<>(armorList).containsAll(Arrays.asList(ModItems.SORCIUM_BLUE_BOOTS, ModItems.SORCIUM_BLUE_LEGGINGS, ModItems.SORCIUM_BLUE_CHESTPLATE, ModItems.SORCIUM_BLUE_HELMET));
