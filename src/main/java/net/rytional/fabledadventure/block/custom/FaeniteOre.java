...
public class FaeniteOre extends Block {
    public static final BooleanProperty LIT;

    public FaeniteOre(Settings settings) {
        super(settings);
    ...
    private static void spawnParticles(World world, BlockPos pos) {
        ...
        for (Direction direction : var5) {
            ...
            if (!world.getBlockState(blockPos).isOpaqueFullCube(world, blockPos)) {
                ...
                world.addParticle(ParticleTypes.ELECTRIC_SPARK, (double) pos.getX() + e, (double) pos.getY() + f, (double) pos.getZ() + g, 0.0, 0.0, 0.0);
            }
        }
