...
public class ModBlocks {
    ...
    public static final Block ULTIUM_ORE = registerBlock("ultium_ore",
            new Block(FabricBlockSettings.of(Material.STONE).strength(1.5f).requiresTool()), ModItemGroups.FABLED);
    public static final Block ORCANITE_ORE_BLOCK = registerBlock("orcanite_ore_block",
            new OrcaniteOre(FabricBlockSettings.of(Material.STONE).strength(1.5f).requiresTool()), ModItemGroups.FABLED);
